...
public class ThirdPersonController : MonoBehaviour
{
    ...
    private void CameraRotation()
    {
        ...
        if (_characterInputSource.look.sqrMagnitude >= Threshold && !lockCameraPosition)
        {
            //Don't multiply mouse input by Time.deltaTime;
            float deltaTimeMultiplier = IsCurrentDeviceMouse ? 1.0f : Time.deltaTime;

            _cinemachineTargetYaw += _characterInputSource.look.x * deltaTimeMultiplier;
            _cinemachineTargetPitch += _characterInputSource.look.y * deltaTimeMultiplier;
        }
